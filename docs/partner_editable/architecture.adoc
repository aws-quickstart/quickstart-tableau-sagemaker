...
* Amazon API Gateway with REST API containing two endpoints (GET /info and POST /evaluate).
...
* In the VPC:
** Two AWS Lambda functions, one for each REST API endpoint (GET /info and POST /evaluate).
