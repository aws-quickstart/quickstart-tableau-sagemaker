...
:quickstart-project-name: quickstart-tableau-sagemaker
...
:partner-contributors: Holt Calder, InterWorks, and Madeleine Corneli, Tableau Software
:quickstart-contributors: Dylan Tong, AWS AI Augmented Analytics, and Shivansh Singh and Tony Bulding, AWS Quick Start team
